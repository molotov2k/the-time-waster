//
//  LocalStatsViewController.swift
//  BigMT
//
...
class LocalStatsViewController: UIViewController, UITabBarDelegate {
    ...
    override func viewWillAppear(animated: Bool) {
        ...
        averageWastedTimeInUseLabel.text = formatElapsedTime(AppData.userPrivateData["averageWasteInUse"]!)
        averageWastedTimeInDayLabel.text = formatElapsedTime(AppData.userPrivateData["averageWasteInDay"]!)
        maxWastedTimeInUseLabel.text = formatElapsedTime(AppData.userPrivateData["maxWasteInUse"]!)
        maxWastedTimeInDayLabel.text = formatElapsedTime(AppData.userPrivateData["maxWasteInDay"]!)
        totalWastedTimeLabel.text = formatElapsedTime(AppData.userPrivateData["totalWaste"]!)
    }
